...
../compute_nn -c 3.0 -n 480 -s 100000 --cycles 100 2D_square_lattice/data/config{0..9}.dat > 2D_square_lattice/480bin.dat
../compute_nn -c 3.0 -n 1920 -s 100000 --cycles 100 2D_square_lattice/data/config{0..9}.dat > 2D_square_lattice/1920bin.dat

if [ "$1" = "--full" ]; then
    ../compute_nn -c 3.0 -n 7680 -s 10000 --cycles 1000 2D_square_lattice/data/config{0..9}.dat > 2D_square_lattice/7680bin.dat
fi
...
../compute_nn -c 3.0 -n 30 -s 100000 1D_poisson/data/config{0..999}.dat > 1D_poisson/30bin.dat
../compute_nn -c 3.0 -n 120 -s 100000 1D_poisson/data/config{0..999}.dat > 1D_poisson/120bin.dat
../compute_nn -c 3.0 -n 480 -s 100000 1D_poisson/data/config{0..999}.dat > 1D_poisson/480bin.dat
../compute_nn -c 3.0 -n 1920 -s 100000 1D_poisson/data/config{0..999}.dat > 1D_poisson/1920bin.dat
...
../compute_nn -c 3.0 -n 30 -s 100000 2D_poisson/data/config{0..999}.dat > 2D_poisson/30bin.dat
../compute_nn -c 3.0 -n 120 -s 100000 2D_poisson/data/config{0..999}.dat > 2D_poisson/120bin.dat
../compute_nn -c 3.0 -n 480 -s 100000 2D_poisson/data/config{0..999}.dat > 2D_poisson/480bin.dat
../compute_nn -c 3.0 -n 1920 -s 100000 2D_poisson/data/config{0..999}.dat > 2D_poisson/1920bin.dat
...
../compute_nn -c 3.0 -n 120 -s 100000 3D_poisson/data/config{0..999}.dat > 3D_poisson/120bin.dat
../compute_nn -c 3.0 -n 480 -s 100000 3D_poisson/data/config{0..999}.dat > 3D_poisson/480bin.dat
../compute_nn -c 3.0 -n 1920 -s 100000 3D_poisson/data/config{0..999}.dat > 3D_poisson/1920bin.dat
...
../compute_nn -c "1.8e-4" -n 480 -s 100000 1D_RSA/data/config{0..1999}.dat > 1D_RSA/480bin.dat
../compute_nn -c "1.8e-4" -n 1920 -s 100000 1D_RSA/data/config{0..1999}.dat > 1D_RSA/1920bin.dat
...
if [ "$1" == "--full" ]; then
    ...
    ../compute_nn -c "2.16e-4" -n 480 -s 100000 1D_RSA_long/data/config{0..19999}.dat > 1D_RSA_long/480bin.dat
    ../compute_nn -c "2.16e-4" -n 1920 -s 100000 1D_RSA_long/data/config{0..19999}.dat > 1D_RSA_long/1920bin.dat
